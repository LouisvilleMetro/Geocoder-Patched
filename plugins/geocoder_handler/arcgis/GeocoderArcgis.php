...
class GeocoderArcgis {
  ...
  protected function buildUrlWithQuery($address) {
	...
	'outSR' => '4326',
	'searchExtent' =>  '',
	'token' => 'JXZIX13XD1dsaWQ-OSVsOmtTgzWlx3BMHyf6RgMs2f_IViJbfSOGmu0qkESCzs6I-lQbDuH5K0y9UGZd_D7eaQ..', //So obnoxious. ags1dev only token
        'f' => 'json'
      )
    );
...
//token aIODK__nqVwId4nfoKOiBqwsLfQzw6uhCxuR-UOxslfPUnMkCbY5c5uyvGpa9fJE || 69.2.216.177
      return $protocol . "://ags1dev.lojic.org/arcgis/rest/services/LOJIC/JeffersonAddresses/GeocodeServer/findAddressCandidates?" . $query;
  }
  ...
  protected function decodeGeometryData($json) {
    ...
    if (empty($data->candidates)) {
      $msg = $this->env->translate('ArcGIS could not find any candidates.'  . print_r($data, true) . print_r($json, true));
      throw new ArcgisException($msg);
    }
